    ...
    render() {
        return (
            <div className="quotes">
                <img src='./images/svgs/start-quotes.svg' alt="Beginning Quotes" className="quote-marks opening for-reviews"/>
                <p className="quote">{reviews[this.props.index].quote}</p>
                <img src='./images/svgs/end-quotes.svg' alt="Closing Quotes" className="quote-marks closing for-reviews"/>
